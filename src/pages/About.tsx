          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              >
                <Link
                  to="/contact"
                  className="inline-flex items-center bg-orange-500 text-white px-8 py-4 rounded-full font-semibold hover:bg-orange-600 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
                >
                ...
                <Link
                  to="/projects"
                  className="inline-flex items-center text-gray-900 dark:text-orange-500 transition-colors font-semibold"
                >
                  Voir nos projets
